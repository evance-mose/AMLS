...
use App\Http\Controllers\LocationTrailController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Admin: Technician location trail (map + history)
    Route::middleware(RoleMiddleware::class.':admin')->group(function () {
        Route::get('location-trail', [LocationTrailController::class, 'index'])->name('location-trail.index');
    });
